module.exports = {
	'quick-mint': {
		...
		similarProjects: ['roden-gray', 'ocin'],
	...
	'vancouver-bitcoin': {
		...
		desktopRes: '1920x1080',
		mobileRes: 'N/A',
		overview: 'Lead Designer for Vancouver Bitcoin\'s website initiative. I was hired to redesign their existing website under a new set of branding guidelines.',
		icons: [
			{ file: 'photoshop-icon.png', alt: 'Photoshop' },
			{ file: 'illustrator-icon.png', alt: 'Illustrator' },
			{ file: 'xd-icon.png', alt: 'XD' },
	...
	'ocin': {
		title: 'Ocin Website',
		tag: 'UI/UX Design',
		briefDescription: 'UI/UX design for an e-commerce website. Front end design for custom Shopify theme.',
		imgRef: 'ocin/thumbnail.png',
		imgAlt: 'Ocin Thumbnail',
		...
		desktopRes: '1920x1080',
		mobileRes: 'N/A',
		overview: 'OCIN is a lifestyle brand and eco-swim label. I was hired as the primary UI/UX designer for OCINs e-commerce website.',
		icons: [
			{ file: 'xd-icon.png', alt: 'XD' },
		],
		component: 'Ocin',
	...
	'roden-gray': {
		...
		tag: 'UI/UX Design',
		briefDescription: 'UI/UX design for an e-commerce website. Front end design for custom Shopify theme.',
		imgRef: 'roden-gray/thumbnail.png',
		imgAlt: 'Roden Gray Thumbnail',
		...
		desktopRes: '1920x1080',
		mobileRes: 'N/A',
		overview: 'Roden Gray is a Designer menswear retail outlet. I was hired as the primary UI/UX designer for their e-commerce website.',
		icons: [
			{ file: 'xd-icon.png', alt: 'XD' },
		],
		component: 'RodenGray',
